...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 1, // 更新缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'KSroido', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '风信子', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ksroido.art', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '安全 开发 编曲 独游', // 网站关键词 英文逗号隔开
